...
if (!isset($_POST["contato"]) || !isset($_POST["nome_contato"]) || !isset($_POST["email_contato"]) || !isset($_POST["telefone_contato"]) || !isset($_POST["cpf_contato"])) {
...
$sql = "SELECT * FROM tbl_contatos INNER JOIN tbl_clientes ON id_cliente = tbl_clientes.id WHERE email_contato = '$email_contato' AND status = '1' AND tbl_contatos.id != '$contato'";
...
$sql = "SELECT * FROM tbl_contatos INNER JOIN tbl_clientes ON id_cliente = tbl_clientes.id WHERE telefone_contato = '$telefone_contato' AND status = '1' AND tbl_contatos.id != '$contato'";
$result_sql = mysqli_query($conn, $sql);
...
$sql = "SELECT * FROM tbl_contatos INNER JOIN tbl_clientes ON id_cliente = tbl_clientes.id WHERE cpf = '$cpf_contato' AND status = '1' AND tbl_contatos.id != '$contato'";
$result_sql = mysqli_query($conn, $sql);
...
$sql = "UPDATE tbl_contatos SET nome_contato = '$nome_contato', email_contato = '$email_contato', telefone_contato = '$telefone_contato', cpf = '$cpf_contato' WHERE id = '$contato'";
